...
urls=$(curl https://github.com/antman666/linux-xanmod-cacule-uksm-cjktty/releases/tag/linux-xanmod-cacule-uksm-cjktty_for_arch-gcc -s | grep "/antman666/linux-xanmod-cacule-uksm-cjktty/releases/download/linux-xanmod-cacule-uksm-cjktty_for_arch-gcc/"|awk -F '"|"' '{print$2}')
