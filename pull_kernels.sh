#!/bin/bash
urls=$(curl https://github.com/antman666/linux-ck-uksm/releases/tag/linux-ck-uksm_v5.16.15-1 -s | grep "/antman666/linux-ck-uksm/releases/download/linux-ck-uksm_v5.16.15-1/"|awk -F '"|"' '{print$2}')
